...
class ExitGateGUI(object):
    ...
    def __init__(self):
        ...
        self.debug_mode = False  # Set to True for debug mode
    ...
    def initialize_services(self):
        ...
        try:
            ...
            try:
                ...
                # # Test camera service asynchronously (non-blocking)
                ...
                # threading.Thread(target=test_camera_worker, daemon=True).start()
