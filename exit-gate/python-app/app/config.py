...
class Config(object):
    ...
    def _create_default_config(self):
        ...
        self.config.set('camera', 'raspberry_pi_enabled', 'True')
        self.config.set('camera', 'raspberry_pi_camera_id', '0')
        self.config.set('camera', 'raspberry_pi_library', 'picamera2')  # picamera2 or picamera or opencv
        self.config.set('camera', 'raspberry_pi_resolution_width', '1920')
        self.config.set('camera', 'raspberry_pi_resolution_height', '1080')
