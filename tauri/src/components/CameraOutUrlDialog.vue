...
cameraOutUrl.value = gateSettings.value?.DRIVER_CAM_URL || ''; // Diubah, asumsi DRIVER_CAM_URL untuk kamera keluar
});

const onSaveSettings = () => {
  const newSettings = { ...gateSettings.value, DRIVER_CAM_URL: cameraOutUrl.value };
